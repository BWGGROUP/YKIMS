 ...
 */
package cn.com.sims.crawler.souplang.nodes;

import cn.com.sims.crawler.souplang.Context;
import cn.com.sims.crawler.souplang.LangNode;
    ...
    public Object process(Object input, Context context) throws InputTypeErrorException {
        ...
        if (params !=null ) {
            ...
            for (int i = 0; i < paramsLength; i++) {
                ...
                System.out.println("context.getString(paramarray[i]) :"+context.getString(paramarray[i])+" i＝: "+paramarray[i]);
            }
