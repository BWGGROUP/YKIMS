						...
						<div class="right-group-box-body">
							<div class="select_kuang">
								<div class="items">
									...
									<div class="con name">${kuanginfo.sys_wad_name}</div>
                                     <div class="con "><input class="fn-input name-input" maxlength="20"></div>
								</div>
								<div class="items">
									<div class="lable">权限:</div>
    <c:forEach items="${juilist}" var="list">
    <div class="con">
    <input name='checkbox' type="checkbox" ${list.checked} ${list.disabled} code="${list.sys_juri_code}"> <span maxlength="100">${list.sys_juri_name}</span>
    </div>
    </c:forEach>
...
<script type="text/javascript"
	src="view/pc/common/js/employee/kuang_manage.js"></script>
</html>